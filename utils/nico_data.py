...
def generate_nico_dg_train_ours(ours_data_limit):
    ...
    train_saving_file_name = "train_files_" + str(ours_data_limit) + ".txt"
    train_file_txt = os.path.join(base_path, train_saving_file_name)
...
def load_data_for_domain(domain, is_train=True, samples=10):
