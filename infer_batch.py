...
if __name__ == "__main__":
    ...
    parser.add_argument('--category_path', type=str, default="/data/cateogry/path", help='path to the dataset folder')    
    parser.add_argument('--save_path', type=str, default="/save/path/", help='Path where the generated images will be saved')
